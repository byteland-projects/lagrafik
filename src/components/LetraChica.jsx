  ...
  const terminos = [
    {
      ...
      texto: "Trabajamos con una seña del 50%. El precio final se congela por 7 días luego de pactado el retiro; luego de ese plazo, cualquier aumento de insumos se trasladará al costo."
    },
    {
